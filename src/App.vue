              ...
              <div class="relative px-4 sm:px-8 lg:px-12">
                <div class="mx-auto max-w-2xl lg:max-w-5xl">
                  <div class="relative flex gap-4">
                    ...
                    <div @click="next()" class="flex justify-end md:flex-1">
            ...
            <div class="relative px-4 sm:px-8 lg:px-12">
              <div class="mx-auto max-w-2xl lg:max-w-5xl">
                <div class="max-w-2xl">
                  ...
                  >
                    Software Engineer and founder. {{ colorMode }}
                  </h1>
                  <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                    I’m Leonard, a software engineer and entrepreneur based in
                    Kenya. I work at Techplain in Kenya as a software engineer.
                    I’m also the founder and CEO of Artworld, where we develop
                    technologies that empower regular people to automate their
                ...
                <div class="mx-auto max-w-2xl lg:max-w-5xl">
                  ...
                  >
                    ...
                    <p class="text-sm text-zinc-400 dark:text-zinc-500">
                      ©
                      <!-- -->2022<!-- -->
                      Leonard Mbugua. All rights reserved.
                    </p>
                  </div>
                </div>
              </div>
